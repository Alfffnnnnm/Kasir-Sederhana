			...
			<?php if ($d['PelangganID'] == $PelangganID) { ?>
				...
				<form method="post" action="simpan_total_harga.php">
					...
					<div class="row">
						...
						<div class="col-sm-2">
							<div class="form-group">
								<button class="btn btn-info btn-sm form-control" type="submit"><b>SIMPAN</b></button>
								<a href="cetak_struk.php" target="_BLANK" class="btn btn-info btn-sm form-control" type="submit"><b>CETAK STRUK</b></a>
							</div>
						</div>
					</div>
				</form>
